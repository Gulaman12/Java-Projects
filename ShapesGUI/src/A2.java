...
public class A2 extends JFrame {
	...
	* @return toolsPanel		the Panel
	...
	public JPanel setUpToolsPanel() {
		...
		ImageIcon rotatingSquareButtonIcon = createImageIcon("RotatingSquare.gif");
		ImageIcon triangleButtonIcon = createImageIcon("polygon.gif");
		ImageIcon rectangleButtonIcon = createImageIcon("rectangle.gif");
		ImageIcon squareButtonIcon = createImageIcon("square.gif");
		JComboBox<ImageIcon> shapesComboBox = new JComboBox<ImageIcon>(new ImageIcon[] {rectangleButtonIcon,squareButtonIcon,triangleButtonIcon,rotatingSquareButtonIcon} );
		...
		ImageIcon jumpingLeftButtonIcon = createImageIcon("jumpingLeft.gif");
		JComboBox<ImageIcon> pathComboBox = new JComboBox<ImageIcon>(new ImageIcon[] {fallingButtonIcon,jumpingLeftButtonIcon});
