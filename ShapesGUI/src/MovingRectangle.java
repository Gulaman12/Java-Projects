 ...
 *	The rectangle has 4 handles shown when it is selected (by clicking on it).
 *	===============================================================================
 */
import java.awt.*;
public class MovingRectangle extends MovingShape {
	 ...
	 */
	public MovingRectangle(int x, int y, int w, int h,  int mw, int mh, Color bc, int pathType, float pen) {
