...
public class AnimationPanel extends JComponent implements Runnable {
	...
	ArrayList<MovingShape> shapeList = new ArrayList<MovingShape>(); 	
	 /** Constructor of the AnimationPanel
		*/
	public AnimationPanel() {
		shapeList = new ArrayList<MovingShape>();
	...
	protected void createNewShape(int x, int y) {
		...
		switch (currentShapeType) {
			case 0: { //rectangle
				s =  new MovingRectangle(x, y, currentWidth, currentHeight, marginWidth, marginHeight, currentBorderColor,currentPath, currentPenWidth);
				shapeList.add(s);
				break;
			}
			case 1: {
				s =  new MovingSquare(x, y, currentWidth, currentHeight, marginWidth, marginHeight, currentBorderColor,currentPath, currentPenWidth);
				shapeList.add(s);
				break;
			}
			case 2: {
				s =  new MovingPolygon(x, y, currentWidth, currentHeight, marginWidth, marginHeight, currentBorderColor,currentPath, currentPenWidth);
				shapeList.add(s);
				break;
			}
			case 3: {
				s =  new RotatingSquare(x, y, currentWidth, currentHeight, marginWidth, marginHeight, currentBorderColor,currentPath, currentPenWidth);
				shapeList.add(s);
				break;
			}
		}
